...
const advisors = [
  {
    ...
    specializationLabels: ["Mutual Funds", "EPF Guidance", "Inheritance Planning"],
  ...
  },
  {
    ...
    specializationLabels: ["Mutual Funds", "NRI Services", "Global Investments"],
    bio: "SEBI RIA specializing in goal-based investing and NRI financial planning.",
  },
];
...
function AdvisorsContent() {
  ...
  const filtered = service
    ? advisors.filter((a) => a.specializations.includes(service))
    : advisors;
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-24">
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            All advisors are SEBI registered. Browse and connect directly.
          </p>
        </div>
              ...
              >
                ...
                <div className="flex justify-between items-center pt-4 border-t border-white/10">
                  <span className="text-gray-500 text-xs">{advisor.experience} years experience</span>
                    ...
                    className="bg-emerald-500 hover:bg-emerald-400 text-black text-sm font-bold px-4 py-2 rounded-full transition-colors"
                  >
                    View Profile
                  </a>
                </div>
